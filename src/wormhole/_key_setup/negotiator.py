...
class Negotiator:
    ...
    def _build_panel(self, code):
        ...
        if "v1" in self._key_setup_versions:
            ...
            panel["v1"] = ks1
        if "v2" in self._key_setup_versions:
            ks2 = c["v2"](self._side, self._appid, self._app_versions, self._timing, sph)
            panel["v2"] = ks2
    ...
    def _build_negotiator(self, version):
        ...
        match version:
            ...
            case "v2":
                return c["v2"](self._side, self._appid, self._app_versions, self._timing, sph)
